-- =============================================================
-- ATUALIZAÇÃO TEMPORADA 2025 - DADOS CORRIGIDOS
-- Execute este script no SQL Editor do Supabase
-- =============================================================

-- PASSO 1: Remover dados anteriores da rodada histórica
...
-- PASSO 2: Inserir dados corrigidos (Presença, Gols, Assists, Vitorias, Empates, Derrotas, PontosTotais)
WITH round_2025 AS (
...
SELECT p.nickname, prs.goals, prs.assists, prs.victories, prs.draws, prs.defeats, prs.presence_points, prs.total_points
