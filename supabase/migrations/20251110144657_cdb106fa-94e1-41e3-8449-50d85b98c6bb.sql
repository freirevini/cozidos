-- Fix recalc_round_aggregates to anchor by profiles.id and use correct scoring rules
...
BEGIN
  ...
  LOOP
    ...
    -- Calculate individual point components (official rules)
    victory_points := victories * 10;
    draw_points := draws * 5;
    ...
    card_points := (yellow_cards + red_cards) * -1;
