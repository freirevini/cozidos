-- Garantir que created_by aceita NULL
ALTER TABLE public.player_ranking_adjustments 
  ALTER COLUMN created_by DROP NOT NULL;

-- Modificar função para usar NULL e validar sessão explicitamente
...
BEGIN
  ...
  IF v_new_adjustment != 0 THEN
    INSERT INTO public.player_ranking_adjustments (
      ...
      v_created_by  -- Pode ser NULL agora (se a validação acima falhar, já retornou)
    );
