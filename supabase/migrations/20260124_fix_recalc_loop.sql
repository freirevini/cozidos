-- ============================================================
-- MIGRATION: Fix Recalc Loop to Include Absent Players
-- Data: 2026-01-24
-- ============================================================
-- 
-- PROBLEM: 
-- The previous loop only iterated over `round_team_players`. 
-- Players who were NOT in a team (no round_team_players entry) but had a 
-- record in `round_absences` (e.g., 'falta' or 'atrasado') were skipped completely.
-- This resulted in 0 points instead of negative points for absences.
--
-- SOLUTION:
-- Update loop to UNION `round_team_players` AND `round_absences` to ensure
-- everyone with ANY record for the round is processed.
-- ============================================================
